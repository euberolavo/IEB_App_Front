...
export default function ParticipantsEncontroHomens() {
    ...
    async function fetchParticipants() {
      try {
        const response = await fetch(
          `${config.caminhoServidor}/api/participantstype/Encontro/participantssex/Masculino`
